...
class MasternodeManager(object):
    ...
    def get_masternode_outputs(self, domain = None, exclude_frozen = True):
        ...
        # Valid outputs have a value of exactly 1000 SPARKS and
    ...
    def check_can_sign_masternode(self, alias):
        ...
        if mn.vin.get('value', 0) != bitcoin.COIN * 1000:
            raise Exception('Masternode requires a collateral 1000 SPARKS output.')
    ...
    def save(self):
        ...
        for mn in self.masternodes:
            ...
            #FIXME#
            #masternodes[mn.alias]['announced'] = True
