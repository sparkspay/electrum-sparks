...
class Bittrex(ExchangeBase):
    def get_rates(self, ccy):
        json = self.get_json('bittrex.com',
                             '/api/v1.1/public/getticker?market=%s-SPARKS' % ccy)
        quote_currencies = {}
...
class Poloniex(ExchangeBase):
    def get_rates(self, ccy):
        ...
        quote_currencies = {}
        sparks_ticker = json.get('BTC_SPARKS')
        quote_currencies['BTC'] = Decimal(sparks_ticker['last'])
        return quote_currencies
