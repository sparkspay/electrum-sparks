...
from electrum_sparks.plugin import BasePlugin, hook
from electrum_sparks.i18n import _
from electrum_sparks.util import to_bytes, make_dir
from electrum_sparks.gui.qt.util import *
from electrum_sparks.gui.qt.qrtextedit import ScanQRTextEdit
...
class Plugin(BasePlugin):
    ...
    def calibration_pdf(self, image):
        ...
        painter.drawText(700, 2277, _("2. Align your Revealer borderlines to the sparksed lines on the top and left."))
    ...
    def overlay_marks(self, img, is_cseed=False, calibration_sheet=False):
        ...
        if not calibration_sheet:
            if is_cseed: #its a secret
                painter.setPen(QPen(Qt.black, 1, Qt.sparksDotDotLine))
