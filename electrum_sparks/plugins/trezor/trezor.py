...
from electrum_sparks.util import bfh, bh2u, versiontuple, UserCancelled
from electrum_sparks.bitcoin import (b58_address_to_hash160, xpub_from_pubkey, deserialize_xpub,
                                   TYPE_ADDRESS, TYPE_SCRIPT, is_address)
from electrum_sparks import constants
from electrum_sparks.i18n import _
from electrum_sparks.plugin import BasePlugin, Device
...
class TrezorPlugin(HW_PluginBase):
    ...
    def get_coin_name(self):
        return "Sparks Testnet" if constants.net.TESTNET else "Sparks"
