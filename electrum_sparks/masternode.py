...
class MasternodeAnnounce(object):
    ...
    Attributes:
        ...
        - vin: 1K Sparks input (outpoint: 1K Sparks input for proto > 70208).
        - addr: Address that the masternode can be reached at.
        - collateral_key: Key that can spend the 1K Sparks input.
    ...
    def check_latest_protocol_version(cls, raw):
        try:
            ...
            protocol_version = vds.read_uint32()
            if protocol_version in [70206, 70210]:
                return True
            else:
                return False
        except:
