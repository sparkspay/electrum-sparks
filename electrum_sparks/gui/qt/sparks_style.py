"""Sparks look and feel."""

sparks_stylesheet = """

/**********************/
/* SPARKS Evolution CSS */
/*
0. OSX Reset
1. Navigation Bar
...
#main_window_nav_bar QTabBar::tab {
    background-color:#FF5555; /* changeme */
    color:#fff;
    min-height: 44px;
    padding-left:1em;
    padding-right:1em;
...
QToolBar {
    background-color:#f8f6f7; /* changeme */
...
QPushButton { /* Global Button Style */
    background-color:qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: .01 #FF5555, stop: .1 #B12626, stop: .95 #B12626, stop: 1 #FF5555 );
    border:0;
    border-radius:3px;
    color:#ffffff;
    /* font-size:12px; */
...
QPushButton:hover {
    background-color:qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: .01 #FF5555, stop: .1 #FF5555, stop: .95 #FF5555, stop: 1 #FF5555);
}
...
QComboBox::down-arrow {
    border-image: url(':/icons/sparks_downArrow.png') 0 0 0 0 stretch stretch;
}
...
QAbstractSpinBox::down-button {
    ...
    border-left:0px;
    border-right:1px solid #B12626;
    border-bottom:1px solid #B12626;
    padding-right:1px;
    padding-left:5px;
    padding-bottom:2px;
}
...
QAbstractSpinBox::up-arrow {
    image: url(:/icons/sparks_upArrow_small.png);
    width: 10px;
    height: 10px;
}

QAbstractSpinBox::up-arrow:disabled, QAbstractSpinBox::up-arrow:off {
    image: url(:/icons/sparks_upArrow_small_disabled.png);
}

QAbstractSpinBox::down-arrow {
    image: url(:/icons/sparks_downArrow_small.png);
    width: 10px;
    height: 10px;
}

QAbstractSpinBox::down-arrow:disabled, QAbstractSpinBox::down-arrow:off {
    image: url(:/icons/sparks_downArrow_small_disabled.png);
}
...
QHeaderView::section { /* Table Header Sections */
    ...
    /*** background-color:qlineargradient(x1: 0, y1: 0, x2: 0, y2: 0.25, stop: 0 #FF5555, stop: 1 #B12626); ***/
    background-color:qlineargradient(x1: 0, y1: 0, x2: 0, y2: 0.25, stop: 0 #FF5555, stop: 1 #B12626);
    color:#fff;
    font-weight:bold;
    font-size:11px;
...
QScrollBar:up-arrow {
    background-image: url(':/icons/sparks_upArrow_small.png');
}

QScrollBar:down-arrow {
    background-image: url(':/icons/sparks_downArrow_small.png');
}

QScrollBar:left-arrow {
    background-image: url(':/icons/sparks_leftArrow_small.png');
}

QScrollBar:right-arrow {
    background-image: url(':/icons/sparks_rightArrow_small.png');
}
