...
from electrum_sparks.util import base_units_list
...
from electrum_sparks import coinchooser
...
<SettingsDialog@Popup>
    id: settings
    title: _('Sparks-Electrum Settings')
    disable_pin: False
        ...
        ScrollView:
            GridLayout:
                ...
                SettingsItem:
                    ...
                    description: _("Base unit for Sparks amounts.")
...
class SettingsDialog(Factory.Popup):
    ...
    def proxy_dialog(self, item, dt):
        if self._proxy_dialog is None:
            ...
            popup = Builder.load_file('electrum_sparks/gui/kivy/uix/ui_screens/proxy.kv')
