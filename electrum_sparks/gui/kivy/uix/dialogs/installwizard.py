...
from electrum_sparks.base_wizard import BaseWizard
from electrum_sparks.util import is_valid_email
...
#:import _ electrum_sparks.gui.kivy.i18n._
...
<WizardTextInput@TextInput>
    ...
    background_color: (1, 1, 1, 1) if self.focus else (0.906, 0.494, 0.494, 1)
    #### background_color: (1, 1, 1, 1) if self.focus else (1 ,1 ,1 , 1)
    ## foreground_color: (0.31, 0.31, 0.31, 1) if self.focus else (0.835, 0.909, 0.972, 1)
    foreground_color: (0.31, 0.31, 0.31, 1) if self.focus else (1, 0.333, 0.333, 1)
    #### foreground_color: (0.31, 0.31, 0.31, 1) if self.focus else (1, 1, 1, 1)
    hint_text_color: self.foreground_color
    background_active: 'atlas://electrum_sparks/gui/kivy/theming/light/create_act_text_active'
    background_normal: 'atlas://electrum_sparks/gui/kivy/theming/light/create_act_text_active'
    size_hint_y: None
    height: '48sp'
    ...
    BoxLayout:
        ...
        GridLayout:
            ...
            Label:
                ...
                text: 'SPARKS ELECTRUM'
                size_hint: 1, None
                height: self.texture_size[1] if self.opacity else 0
                font_size: '33sp'
                font_name: 'electrum_sparks/gui/kivy/data/fonts/tron/Tr2n.ttf'
        GridLayout:
            cols: 1
            id: crcontent
            spacing: '1dp'
...
<SeedButton@Button>:
    ...
    color: .1, .1, .1, 1
    background_normal: 'atlas://electrum_sparks/gui/kivy/theming/light/white_bg_round_top'
...
<AddXpubDialog>
    ...
    GridLayout
        ...
        IconButton:
            ...
            icon: 'atlas://electrum_sparks/gui/kivy/theming/light/camera'
            size_hint: 1, None
        WizardButton:
            text: _('Paste')
...
class RestoreSeedDialog(WizardDialog):
    ...
    def __init__(self, wizard, **kwargs):
        ...
        from electrum_sparks.old_mnemonic import words as old_wordlist
...
class InstallWizard(BaseWizard, Widget):
    ...
    def waiting_dialog(self, task, msg, on_finished=None):
        ...
        app.show_info_bubble(
            text=msg, icon='atlas://electrum_sparks/gui/kivy/theming/light/important',
