...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        '''
        return NdefRecord.createApplicationRecord(JString("org.sparks.electrum.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "org.sparks.electrum"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "org.sparks.electrum:externalType",
                '',
                data)
        return extRecord
