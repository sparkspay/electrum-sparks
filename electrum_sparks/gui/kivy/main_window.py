...
from electrum_sparks.bitcoin import TYPE_ADDRESS
from electrum_sparks.storage import WalletStorage
from electrum_sparks.wallet import Wallet
from electrum_sparks.paymentrequest import InvoiceStore
from electrum_sparks.util import profiler, InvalidPassword
from electrum_sparks.plugin import run_hook
from electrum_sparks.util import format_satoshis, format_satoshis_plain
from electrum_sparks.paymentrequest import PR_UNPAID, PR_PAID, PR_UNKNOWN, PR_EXPIRED
from .i18n import _
...
#Factory.register('InstallWizard', module='electrum_sparks.gui.kivy.uix.dialogs.installwizard')
#Factory.register('InfoBubble', module='electrum_sparks.gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='electrum_sparks.gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='electrum_sparks.gui.kivy.uix.dialogs')
...
Factory.register('TabbedCarousel', module='electrum_sparks.gui.kivy.uix.screens')
...
from electrum_sparks.util import (base_units, NoDynamicFeeEstimates, decimal_point_to_base_unit_name,
...
class ElectrumWindow(App):
    ...
    def choose_server_dialog(self, popup):
        ...
        protocol = 's'
        def cb2(host):
            from electrum_sparks import constants
    ...
    def on_qr(self, data):
        from electrum_sparks.bitcoin import base_decode, is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
        if data.startswith('sparks:'):
            self.set_URI(data)
            return
        # try to decode transaction
        from electrum_sparks.transaction import Transaction
        from electrum_sparks.util import bh2u
        try:
    ...
    def show_pr_details(self, req, status, is_invoice):
        from electrum_sparks.util import format_time
        requestor = req.get('requestor')
        exp = req.get('exp')
        memo = req.get('memo')
        amount = req.get('amount')
        fund = req.get('fund')
        popup = Builder.load_file('electrum_sparks/gui/kivy/uix/ui_screens/invoice.kv')
    ...
    def scan_qr(self, on_complete):
        ...
        SimpleScannerActivity = autoclass("org.sparks.electrum.qr.SimpleScannerActivity")
    ...
    def build(self):
        return Builder.load_file('electrum_sparks/gui/kivy/main.kv')
    ...
    def on_start(self):
        ...
        # bind intent for sparks: URI scheme
        if platform == 'android':
            from android import activity
            from jnius import autoclass
            PythonActivity = autoclass('org.kivy.android.PythonActivity')
    ...
    def show_tor_warning(self):
        ...
        img_error = 'atlas://electrum_sparks/gui/kivy/theming/light/error'
    ...
    def load_wallet_by_name(self, path, ask_if_wizard=False):
        ...
        if wallet:
            ...
            Logger.debug('Sparks-Electrum: Wallet not found or action needed. Launching install wizard')
    ...
    def popup_dialog(self, name):
        if name == 'settings':
            ...
            popup = Builder.load_file('electrum_sparks/gui/kivy/uix/ui_screens/'+name+'.kv')
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_sparks.gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_sparks.gui.kivy.uix.qrcodewidget')

        # preload widgets. Remove this if you want to load the widgets on demand
        #Cache.append('electrum_sparks_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('electrum_sparks_widgets', 'QRCodeWidget', Factory.QRCodeWidget())
        ...
        self.icon = "icons/electrum-sparks.png"
    ...
    def get_max_amount(self):
        from electrum_sparks.transaction import TxOutput
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('Sparks-Electrum', message,
                            app_icon=icon, app_name='Sparks-Electrum')
        except ImportError:
    ...
    def show_error(self, error, width='200dp', pos=None, arrow_pos=None,
        exit=False, icon='atlas://electrum_sparks/gui/kivy/theming/light/error', duration=0,
        modal=False):
    ...
    def show_info(self, error, width='200dp', pos=None, arrow_pos=None,
        ...
        '''
        self.show_error(error, icon='atlas://electrum_sparks/gui/kivy/theming/light/important',
    ...
    def show_info_bubble(self, text=_('Hello World'), pos=None, duration=0,
        ...
        if text == 'texture':
            ...
            info_bubble.background_image = 'atlas://electrum_sparks/gui/kivy/theming/light/card'
        else:
