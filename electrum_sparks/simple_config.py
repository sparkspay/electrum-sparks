...
class SimpleConfig(PrintError):
    ...
    def electrum_path(self):
        ...
        self.print_error("electrum-sparks directory", path)
        return path
    ...
    def convert_version_3(self):
        ...
        if isinstance(base_unit, str):
            ...
            map_ = {'sparks':8, 'msparks':5, 'usparks':2, 'sprites':0, 'sat':0}
    ...
    def get_fee_text(self, pos, dyn, mempool, fee_rate):
        ...
        if fee_rate is None:
            ...
            rate_str = format_fee_satoshis(fee_rate) + ' sprites/kB'
...
def read_user_config(path):
    """Parse and store the user config settings in electrum-sparks.conf into user_config[]."""
    if not path:
        return {}
