...
Manual zip aligning:
    ...
    android-sdk-linux/build-tools/27.0.3/zipalign -v 4 \
        Sparks_Electrum-3.0.6.1-release-unsigned.apk \
        Sparks_Electrum-3.0.6.1-release.apk
...
SDIST_NAME_PATTERN = re.compile('^Sparks-Electrum-(.*).tar.gz$')
SDIST_DIR_TEMPLATE = 'Sparks-Electrum-{version}'
PPA_SOURCE_NAME = 'electrum-sparks'
...
UNSIGNED_APK_PATTERN = re.compile('^Sparks_Electrum-(.*)-release-unsigned.apk$')
SIGNED_APK_TEMPLATE = 'Sparks_Electrum-{version}-release.apk'
