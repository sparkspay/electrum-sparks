...
exe = EXE(pyz,
          ...
          name=os.path.join('build/electrum-sparks/electrum-sparks', cmdline_name))
...
tctl_exe = EXE(tctl_pyz,
           ...
           upx=False,
           console=True,
           name=os.path.join('build/electrum-sparks/electrum-sparks', 'trezorctl.bin'))
...
app = BUNDLE(coll,
             name=os.path.join('dist', 'Electrum-Sparks.app'),
             appname="Electrum-Sparks",
	         icon='electrum-sparks.icns',
